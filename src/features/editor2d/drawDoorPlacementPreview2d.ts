...
import { drawDoorSwing2d } from "./walls2dPixi";

/** Превью проёма и открывания при двухшаговой установке двери. */
export function drawDoorPlacementPreview2d(
  g: Graphics,
  wall: Wall,
  leftAlongMm: number,
  ...
  valid: boolean,
  t: ViewportTransform,
  opts?: { readonly drawSwing?: boolean },
): void {
  const drawSwing = opts?.drawSwing !== false;
  ...
  if (drawSwing) {
    drawDoorSwing2d(g, wall, leftAlongMm, openingWidthMm, swing, t);
  }
}
